...
export const videoGenerationModelSchema = z.object({
  ...
  maxReferenceImages: z.number().optional().describe('最大参考图片数'),
  maxReferenceVideos: z.number().optional().describe('最大参考视频数'),
  maxReferenceAudios: z.number().optional().describe('最大参考音频数'),
