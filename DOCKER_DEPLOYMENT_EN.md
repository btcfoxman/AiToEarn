...
| `VOLCENGINE_VIDEO_REQUEST_MODE` | Video generation payload mode: `official`, `openai-compatible`, or `auto`, defaults to `official`; official-compatible channels do not need this |
| `VOLCENGINE_VIDEO_GENERATION_TASKS_PATH` | Video generation tasks API path, defaults to `/api/v3/contents/generations/tasks`; official-compatible channels do not need this |
